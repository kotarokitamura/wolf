...
UserRelationship.create(:follower_id => 6, :followed_id => 2)
UserRelationship.create(:follower_id => 6, :followed_id => 3)
UserRelationship.create(:follower_id => 6, :followed_id => 4)
UserRelationship.create(:follower_id => 6, :followed_id => 1)
